...
const conf = JSON.parse(fs.readFileSync('/home/app/function/conf.json', 'utf8'));
const unsecuredLambda = fs.readFileSync(conf.unsecLambda, 'utf8');

// console.log('Unsec lambda: ' + unsecuredLambda)
const labelOrdering = conf.usingPO ? new PartialOrder(conf.labels) : new TotalOrder(conf.min, conf.max);
console.log('Label Ordering')
console.log(labelOrdering)
module.exports.makeShim = function ( allowExtReq) {
    ...
    // for (let handlerName of conf.handlers) {
        ...
        ${unsecuredLambda}
        module.exports(externalEvent, externalContext, externalCallback);
        `);
        ...
        return function (event, context, callback) {
            ...
            let executionEnv = {
                ...
                require: {
                    ...
                    mock: {
                        'kv-store': {
                            KV_Store: function (h, u, pwd, db, tableName) {
